...
CREATE TABLE IF NOT EXISTS payroll_runs (
    ...
    created_by INTEGER REFERENCES users(id), created_at TEXT NOT NULL DEFAULT (datetime('now')), updated_at TEXT NOT NULL DEFAULT (datetime('now')),
...
CREATE TABLE IF NOT EXISTS request_comments (
    ...
    body TEXT NOT NULL, internal INTEGER NOT NULL DEFAULT 0, created_at TEXT NOT NULL DEFAULT (datetime('now'))
);
CREATE TABLE IF NOT EXISTS deliverable_versions (
    ...
    created_at TEXT NOT NULL DEFAULT (datetime('now')), UNIQUE(tenant_id,deliverable_id,version)
);
CREATE TABLE IF NOT EXISTS conversation_messages (
    ...
    body TEXT NOT NULL, message_type TEXT NOT NULL DEFAULT 'text', created_at TEXT NOT NULL DEFAULT (datetime('now'))
);
CREATE TABLE IF NOT EXISTS file_versions (
    ...
    uploaded_by INTEGER REFERENCES users(id), created_at TEXT NOT NULL DEFAULT (datetime('now')),
